...
安装源自带的一些字体，并更新字体缓存。
```
sudo apt update && sudo fonts-adobe-sourcesans3 fonts-firacode fonts-inter fonts-cascadia-code fonts-roboto fonts-noto-cjk fonts-noto-cjk-extra fonts-noto-core fonts-noto-extra fonts-stix fonts-noto-mono fonts-mathjax fonts-font-awesome fonts-lato fonts-open-sans fonts-montserrat fonts-wqy-microhei fonts-wqy-zenhei -y && fc-cache -fv
```
